...
@connect(({ unified, loading }) => ({
  unified,
  loading: loading.models.unified,
}))


@Form.create()
export default class UnifiedList extends PureComponent {
  ...
  handleDeleteData = (e, text, data) => {
    ...
    dispatch({
      type: 'unified/fetchUnified',
      payload: {
        unified_server_ids: [text.unified_server_id],
        filters: this.state.formQueryValues
      },
      callback: () => {
        this.setState({
  ...
  handleEdit = (e, text, data) => {
    ...
    const formValuesArr = {
      unified_server_id: text.unified_server_id,
  ...
  handleAdd = (fields, form) => {
    ...
    let params = {
      unified_server_id: this.state.formAddValues.unified_server_id,
