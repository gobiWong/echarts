  ...
  return (
    ...
    >
      ...
      <Form>
        ...
        <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="记录人">
...
export default class FollowList extends PureComponent {
  ...
  state = {
    ...
    formAddValues: {
      company_operate_follow_record_id: '',
      company_id:'',
      user_id: '',
      origin_content: '',
      current_content:'',
  ...
  handleEdit = (e, text, data) => {
    ...
    const formValuesArr = {
      company_operate_follow_record_id: text.company_operate_follow_record_id,
  ...
  handleAdd = (fields, form) => {
    ...
    let params = {
      company_operate_follow_record_id: this.state.formAddValues.company_operate_follow_record_id,
